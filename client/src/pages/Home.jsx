...
const Home = ({ setProductType, setSearch }) => {
  return (
    <div className="bg-white">
      ...
      <div className="flex flex-col md:flex-row-reverse items-center justify-center gap-2 md:gap-16 mx-auto mt-12 md:mt-32">
        <div className="flex flex-col items-center md:items-start">
          <Lottie className="h-56 md:h-80" animationData={greenRobot} loop={true} />
          <h2 className="text-green-600 text-3xl md:text-5xl font-bold text-center md:text-left">A <span className="text-gray-600">Smarter</span> Way to  <br />Share & Earn</h2>
